In this repo, I have the same Reinforment agent exploreing different envirements. Each enviremnt has a its name in the filename and each envirement comes in pairs of 2 or 3
